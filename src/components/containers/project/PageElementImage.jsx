...
const PageElementImage = ({ element, edit, activePageElement, setActivePageElement, deletePageElement, updatePageElement, setShowSidebarPanel, setSidebarObject, setSidebarObjectTitle, closeAllPanels }) => { 
...
const handleShowElementSettingsRequest = () => {
    ...
    setTimeout(()=>{
        ...
        setSidebarObjectTitle("Image Settings")
